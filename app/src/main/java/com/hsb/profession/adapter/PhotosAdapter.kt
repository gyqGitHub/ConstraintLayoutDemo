package com.hsb.profession.adapter
...
import com.hsb.profession.helpers.Cats
...
class FrontPhotosAdapter : RecyclerView.Adapter<YouTubeDemoViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): YouTubeDemoViewHolder {
        ...
        return when (viewType) {
            ...
            R.layout.motion_24_recyclerview_expanded_row -> YouTubeDemoViewHolder.CatRowViewHolder(
                itemView
            )
